...
public class CBlockTags {
    public static final TagKey<Block> ORES_ALUMINUM = TagUtil.blockTag("c", "ores/aluminum");
    public static final TagKey<Block> ORES_NICKEL = TagUtil.blockTag("c", "ores/nickel");

    public static final TagKey<Block> STORAGE_BLOCKS_ALUMINUM = TagUtil.blockTag("c", "storage_blocks/aluminum");
    public static final TagKey<Block> STORAGE_BLOCKS_NICKEL = TagUtil.blockTag("c", "storage_blocks/nickel");
    public static final TagKey<Block> STORAGE_BLOCKS_INVAR = TagUtil.blockTag("c", "storage_blocks/invar");
